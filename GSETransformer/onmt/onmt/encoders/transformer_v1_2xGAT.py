...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, heads, d_ff, dropout,
        ...
        self.gnn_conv_2 = GATConv(d_model, d_model, heads=heads, dropout=dropout, concat=False)
    ...
    def forward(self, inputs, edge_index, mask):
        ...
        gnn_context_mid = F.elu(self.gnn_conv_1(input_norm_2gnn, edge_index))
        gnn_context = self.gnn_conv_2(gnn_context_mid, edge_index)
    ...
    def update_dropout(self, dropout):
        ...
        self.gnn_conv_2.dropout = dropout
