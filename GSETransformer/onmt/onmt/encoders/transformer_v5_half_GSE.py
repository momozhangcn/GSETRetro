...
from data_utils import EncoderBase
from data_utils import MultiHeadedAttention
from data_utils import PositionwiseFeedForward
...
class TransformerEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, d_model, heads, d_ff, dropout, embeddings,
        ...
        # self.gse_transformer = nn.ModuleList(
    ...
    def forward(self, src_input, lengths=None):
        ...
        # for layer1 in self.gse_transformer:
        #     out = layer1(out, edge_index, mask)
