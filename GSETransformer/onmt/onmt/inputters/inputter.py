...
from onmt.inputters.graph_dataset import graph_fields #check fields
...
def get_fields(
    ...
    assert src_data_type in ['text', 'img', 'audio', 'graph'], \
    ...
    edge_index_field_kwargs = {"n_feats": n_src_feats,
                            "include_lengths": False,
                            "pad": pad, "bos": None, "eos": None,
                            "truncate": src_truncate,
                            "base_name": "edge_index"}
    fields["edge_index"] = fields_getters["graph"](**edge_index_field_kwargs)
