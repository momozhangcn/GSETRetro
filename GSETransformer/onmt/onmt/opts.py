...
def preprocess_opts(parser):
    ...
    group.add('--shard_size', '-shard_size', type=int, default=10000000,
...
def translate_opts(parser):
    ...
    group.add('--shard_size', '-shard_size', type=int, default=500000,
    ...
    group.add('--beam_size', '-beam_size', type=int, default=10,
              help='Beam size')
    group.add('--min_length', '-min_length', type=int, default=1,
              help='Minimum prediction length')
    group.add('--max_length', '-max_length', type=int, default=300,
    ...
    group.add('--n_best', '-n_best', type=int, default=10,
              help="If verbose is set, will output the n_best "
                   "decoded sentences")
    group.add('--expansion_topk', '-expansion_topk', type=int, default=10,
              help="expansion topk for multi step translation")  # expansion_topk
