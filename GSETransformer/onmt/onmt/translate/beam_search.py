...
class BeamSearch(DecodeStrategy):
    ...
    def advance(self, log_probs, attn):
        ...
        self._batch_index = self._batch_index.type(torch.float)## check changefor beam_search
        torch.div(self.topk_ids, vocab_size, out=self._batch_index)
        self._batch_index = self._batch_index.type(torch.long)## check changefor beam_search
